...
export const Quiz = ({ initialPercentage, 
            ...
            />
                ...
                mx-auto text-center items-center justify-center h-full">
                    ...
                    <h1 className="text-xl lg:text-3xl font-bold text-neutral-700">
                        Bom Trabalho! <br /> Você completou a lissão.
                    </h1>
    ...
    "Escolha a setença correta" : challenge.question
        ...
        {incorrectAudio}
            ...
            <div className="flex-1">
                <div className="h-full flex items-center justify-center">
                    <div className="lg:min-h-[350px] lg:w-[600px] w-full 
                    px-6 lg:px-0 flex flex-col gap-y-12">
